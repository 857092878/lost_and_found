# Generated by Django 2.2.5 on 2022-03-26 07:18
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Admin_app', '0007_auto_20220325_2118'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lost_time', models.DateField(verbose_name='捡的时间')),
                ('name', models.CharField(max_length=32, verbose_name='拾主姓名')),
                ('link', models.CharField(max_length=11, verbose_name='拾主联系方式/(QQ/微信)')),
